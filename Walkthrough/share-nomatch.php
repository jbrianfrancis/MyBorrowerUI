...
<html lang="en">
  ...
  <body>
	...
	<div class="col-md-8 col-md-offset-2">
		...
		<div class="row">
			<div class="col-md-7">
			  <a class="btn btn-lg btn-hybrid" href="share-simple.php">Yes, Continue <i class="fa fa-chevron-right"></i></a>
			</div>
			<div class="col-md-5">
			  <a class="btn btn-lg btn-hybrid btn-secondary" href="share-simple.php">No Match</a>
			</div>
		</div>
		 </div>
	</div> <!-- /close col-md-12 -->
